...
public class TheTimeInWords {
	public static void main(String args[]) {
		...
		num1 = sc.nextInt();
		num2 = sc.nextInt();
		String time1[] = { "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven",
				"twelve" };
		String time2[] = { " o' clock", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten",
				"eleven", "twelve", "thirteen", "fourteen", "fivteen", "sixteen", "seventeen", "eighteen", "nineteen",
				"twenty", "twenty one", "twenty two", "twenty three", "twenty four", "twenty five", "twenty six",
				"twenty seven", "twenty eight", "twenty nine", "half past " };
		String output = "";
		if (num1 != 0)
			output = time1[num1 - 1];
		if (num2 == 0)
