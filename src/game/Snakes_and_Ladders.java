...
//used to allow user to input data
public class Snakes_and_Ladders {// start class
    ...
    public static void main (String [] args) throws IOException {// start main method
        ...
        /*
        This while loop makes the board for the player to visualise what the
        ...
        */
        while (counter > 0){// start while
            if (counter%10 == 0 && counter != 100){// checks if the counter is at a 90, or 80...
                if(iteration==-1) {
                    // subtract 9 from the counter and sets it to start adding by one
                    counter-=9;
                    iteration=1;
                } else {
    ...
    */
    public static String startGame (String start) throws IOException { // Receives data from the main method
    // start startGame method
        ...
        int userPosition = 1; // sets the default location for user's piece to 1
        int compPosition = 1; // sets the default location for computer's piece to 1
        ...
        while (playAgain.equals ("y") || playAgain.equals ("Y")) {// loops while the play Again available equals "y" or "Y".
        // start playAgain While
            ...
            // give getP parameters to work with, and receive a final value which can be printed out
        ...
        return playAgain; // returns parameter "playAgain" to main: if the user wants to play the game again
    ...
    */
    public static int getDice (int diceRoll, int diceRoll2) {// start getDies class
    ...
    ladders value.
    */
    // receives two parameter from startGame
    ...
    // start getP
        ...
        if (userPosition < 0 || userPosition > 112) // This is an ERROR TRAP to catch any unwanted system errors that may occur by chance
        {
        ...
        {
            userPosition = userPosition - userRoll; // subtract userRoll from the user position to get back old position
    ...
    top of a snake, or at the bottom of a ladder, and then
    adjusting the compuer's position to match the snakes or
    ladders value.
    */
    
    public static int compgetP (int compPosition, int compRoll, int snakesLaddersArray [], int userPosition) throws IOException {// start compgetP
        
        // NOTE: this method is similar to getP, so the comments are the same for both!!
        // Look at getP's comments if you need help
