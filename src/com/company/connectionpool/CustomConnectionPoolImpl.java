...
public class CustomConnectionPoolImpl implements Runnable, CustomConnectionPool {
	...
	public CustomConnectionPoolImpl(String driver, String url, String username, String password, int initialConnections,
	...
	public synchronized Connection getConnection() throws SQLException {
		if (!availableConnections.isEmpty()) {
			...
			if (((getNumberOfAvailableConnections() + getNumberOfBusyConnections()) < maxConnections)
					&& !connectionPending) {
	...
	public synchronized String toString() {
		...
		result.append(" available: ").append(availableConnections.size()).append("\n");
