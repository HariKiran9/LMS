                ...
                public void run() {
                    for( int j = 0; j < 5; j++ ) {
                        ...
                        if( value < 75 ) {
                            ...
                            System.out.println( Thread.currentThread().getName() + " value after accumulating " + doubleAcum.get() );
                        } else {
                            System.out.println( Thread.currentThread().getName() + " reseting " );
                            doubleAcum.reset();
                            System.out.println( Thread.currentThread().getName() + " value after reseting " + doubleAcum.get() );
                        }
                    }//for
